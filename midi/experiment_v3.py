...
def add_music_layers(midi, frames, color_to_instrument, duration_per_frame, color_mapping, bpm):
    ...
    # Markov chain probabilities for melody transitions (example structure)
    markov_transition_prob = {
        60: {62: 0.5, 64: 0.5},  # C4 can go to D4 or E4
        62: {64: 0.7, 60: 0.3},  # D4 can go to E4 or back to C4
        64: {60: 0.6, 62: 0.4},  # E4 can go to C4 or D4
        # Extend this dictionary with more notes and probabilities as needed
    }
    ...
    for i, frame in enumerate(frames):
        ...
        # Find the nearest color in the mapping
        nearest_color, _ = find_nearest_color(frame_color, color_mapping)
        ...
        logger.debug(f"setinstrument {setinstrument} ") #would log the last item I guess?
